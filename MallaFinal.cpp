...
void StartAnimation(void){
  ...
  cout<<"unset key"<<endl;
  //cout<<"set xrange [-70:150]"<<endl;
  //cout<<"set yrange [-50:110]"<<endl;
...
int main(void)
{
  ...
  Body Spring[N2D];          /*Oscillators Masses*/
  ...
  double x0Break=50, y0Break=30, z0Break=0;                       /*Distance of Separation in each axis*/
