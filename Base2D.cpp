...
void Collider::AllForces(Body* Spring){
  ...
  for(i=0;i<N2D+1;i++){Spring[i].EraseForce();}
...
int main(void)
{
  ...
  double m0=1 ,r0=5 ,Rx0=Lx/8   ,Ry0=Lx/10  ,Rz0=0,Vx0=0,Vy0=0 ,Vz0=0;   /*Initial Conditions*/
  double m1=10,r1=50,Rx1=Lx*Nx/4,Ry1=Ly*Ny,Rz1=0,Vx1=0,Vy1=10,Vz1=0;     /*Initial Conditions*/
  double x0Break=Lx/2, y0Break=3*Ly/10, z0Break=0;                       /*Distance of Separation in each axis*/
  ...
  /*Start Springs*/
  for(i=0;i<Nx;i++){for(j=0;j<Ny;j++){Spring[i+Nx*j].Start(Rx0,Ry0,Rz0,Vx0,Vy0,Vz0,m0,r0,i*x0Break,j*y0Break,z0Break);}}
  /*Start Sphere*/
  Spring[N2D].Start(Rx1,Ry1,Rz1,Vx1,Vy1,Vz1,m1,r1,0,0,0);
  /*Start Animation*/
